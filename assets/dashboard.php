    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg" style="border-radius: 24px; border: none; background: rgba(255,255,255,0.95); backdrop-filter: blur(10px);">
            ...
            <div class="modal-body text-center px-4 pb-4 mt-n3">
                ...
                <h4 class="fw-bolder text-dark mb-1">Porcalabs</h4>
                ...
                <div class="d-grid gap-3 px-3">
                    <a href="https://www.tiktok.com/@porcalabs" target="_blank" class="btn rounded-pill fw-bold py-2 d-flex align-items-center justify-content-center text-white shadow-sm" style="background: linear-gradient(135deg, #010101, #ee1d52); border: none;">
                        <i class="bi bi-tiktok fs-5 me-2"></i> TikTok Porcalabs
                    </a>
                    <a href="https://wa.me/6285156110395" target="_blank" class="btn rounded-pill fw-bold py-2 d-flex align-items-center justify-content-center text-white shadow-sm" style="background: linear-gradient(135deg, #25d366, #128c7e); border: none;">
                        <i class="bi bi-whatsapp fs-5 me-2"></i> WhatsApp Porcalabs
                    </a>
                </div>
            </div>
            <div class="modal-footer justify-content-center border-0 bg-light py-3">
                <span class="small text-muted fw-bold">&copy; <?= date('Y') ?> | Developer by Porcalabs</span>
            </div>
        </div>
    </div>
</div>
