...
if(isset($_POST['proses_bulk'])){
    ...
    if(!empty($kelas_target) && !empty($sesi_baru)){
        ...
        if($query){
            ...
            echo "<script>alert('Sukses! $jumlah siswa di lembaga $kelas_target berhasil dipindah ke Sesi $sesi_baru.'); window.location='data_siswa.php';</script>";
        } else {
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <div class="d-flex align-items-center mb-4">
                ...
                <h4 class="fw-bold m-0">Pindah Sesi Per Lembaga</h4>
            </div>
            ...
            <div class="card bulk-card p-4 p-md-5">
                <div class="info-box p-3 mb-4">
                    <p class="small m-0 text-dark">
                        ...
                        Fitur ini akan merubah <strong>SEMUA SISWA</strong> dalam satu lembaga ke sesi yang dipilih secara sekaligus. Cocok digunakan saat pergantian tahun ajaran atau perubahan jadwal shift.
                    </p>
                </div>

                <form method="POST" onsubmit="return confirm('Apakah Anda yakin ingin merubah sesi untuk SELURUH SISWA di lembaga ini?')">
                    <div class="mb-4">
                        <label class="form-label fw-bold small">1. PILIH LEMBAGA</label>
