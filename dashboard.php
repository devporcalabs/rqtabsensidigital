        ...
        <div class="col-lg-8">
            <div class="glass-card p-4 h-100">
                ...
                <div class="row g-2 g-md-3">
                    ...
                    <div class="col-4 col-md-3"><a href="rekap_bulanan.php" class="menu-btn"><div class="icon-flat"><img src="https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Spiral%20calendar/3D/spiral_calendar_3d.png"></div><span class="menu-text">Rekap</span></a></div>
                    <?php endif; ?>
                    ...
                    <?php
                    // --- ENCRYPTED DEVELOPER BUTTON ---
                    $btn_dev = "";
                    echo base64_decode($btn_dev);
                    ?>
                </div>
            </div>
        </div>
