...
if ($role !== 'admin' && $role !== 'bendahara') {
    die("<div style='text-align:center; padding:50px; font-family:sans-serif;'><h2>Akses Ditolak</h2><p>Laporan SPP hanya dapat diakses oleh Administrator dan Bendahara.</p></div>");
}
