...
try {
    ...
    // --- CEK DUPLIKAT DI TABEL GURU ---
    $query_guru = mysqli_query($conn, "SELECT id, nama, face_embedding FROM guru WHERE face_embedding IS NOT NULL AND id != '$id_target'");
    ...
    // --- CEK DUPLIKAT DI TABEL SISWA ---
    $query_siswa = mysqli_query($conn, "SELECT id, nama, face_embedding FROM siswa WHERE face_embedding IS NOT NULL");
